...
simul=struct('N', 100, 'nEstimates', 5, 'np', 0, 'maxError', 0.001, 'l', 100, 'diffConv', 100); 
y=zeros(simul.N,1);
y(1)=25;
...
theta = f_rational_model(simul, model, [y(1)], y, y, 0, 0)
y3=f_y_model([y(1)], y, 0,0,mean(theta), model)
