...
rr=rl;
for k=2:N-1
    uu(k)=(mn/a2*ee(k) + (1-mn)/a2*yy(k) +mn*b1/a2*rr(k)*yy(k-1)^2 +(1-mn)*b1/a2*yy(k-1)^2*yy(k))/(1+a1/a2*yy(k));
end

theta0=[mn/a2 (1-mn)/a2 mn*b1/a2 (1-mn)*b1/a2 a1/a2]
theta
u2=f_y_model([0], e, y, rl, theta0, m_rat);
u3=f_y_model([0], e, y, rl, theta, m_rat);
